...
/* =============================================================================
 # $Id:: PsicquicRestImpl.java 2004 2013-09-26 01:52:11Z lukasz99              $
 # Version: $Rev:: 2004                                                        $
 #==============================================================================
 #
...
public class PsicquicRestImpl implements PsicquicRest{
    ...
    public Object getByQuery( String query, String format,
        ...
        if( format != null && format.equalsIgnoreCase("count")){
            mitab += psqServer.getMaxCount( qrs ); 
                ...
                try{
                    ...
                    return prepareResponse( psqServer, qrs.getMaxResult(), format,
            ...
            mitab += psqServer.getHeader( format );
        ...
        if(format != null && format.equals("count")){
            log.info( "getByQuery: count >" + mitab + "<");
        }
    ...
    protected Response.ResponseBuilder 
        ...
        if( result instanceof Long){
            rb.entity( new GenericEntity<Long>( (Long) result ){} );
        } else {
