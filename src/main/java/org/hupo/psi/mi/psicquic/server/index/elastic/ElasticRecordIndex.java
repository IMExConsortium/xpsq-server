package org.hupo.psi.mi.psicquic.server.index.elastic;

/* =============================================================================
 # $Id:: SolrRecordIndex.java 2005 2013-09-26 17:24:55Z lukasz99               $
 # Version: $Rev:: 2005                                                        $
 #==============================================================================
 #
 # ElasticRecordIndex: access to elasticsearch-based index
 #         NOTE: experimental
 #               
 #   
 # ========================================================================== */
...
public class ElasticRecordIndex implements RecordIndex{
    ...
    public ElasticRecordIndex(){}
    
    public ElasticRecordIndex( PsqContext context, int solrconTCount ){
        this.psqContext = context;
        this.solrconTCount = solrconTCount;
        initialize( true );
    }
    
    public ElasticRecordIndex( PsqContext context, String host,
                               int solrconTCount ){
        this.psqContext = context;
        this.solrconTCount = solrconTCount;
    ...
    public ElasticRecordIndex( PsqContext context ){
        this.psqContext = context;
        initialize( true );
    }
    ...
    public void initialize( boolean force ){
        ...
        if( force || baseUrl == null ){
            ...
            log.info( " initilizing ElasticRecordIndex: psqContext=" + psqContext );
	    if( psqContext != null ){
		log.debug( "JsonConfig:\n" + psqContext.getJsonConfig() );
            ...
            if( psqContext != null && psqContext.getJsonConfig() != null ){
                ...
                Map jESCon = (Map) 
                    ((Map) psqContext.getJsonConfig().get("index")).get("elastic");
                
                log.info( "    url=" + jESCon.get("url") );
                log.info( "    shard=" + jESCon.get("shard") );
                log.info( "    host=" + host );
                
                baseUrl = (String) jESCon.get("url");
                
                if( host != null ){
                    //baseUrl = hostReset( baseUrl , host );
                }
                /*
                if( jESCon.get("shard") != null ){
	...
	Log log = LogFactory.getLog( this.getClass() );
        /* 
        log.debug( "query: DefESParams=" + defESParams );
    ...
    public void connect() throws MalformedURLException{
        ...
        Log log = LogFactory.getLog( this.getClass() );
        log.info( "ElasticRecordIndex: connecting" );
        /*   
        ...
        */
        log.info( "ElasticRecordIndex: connected" );
    }
    ...
    */
    ...
    private List<String> processFile( PsqTransformer rt, String fileName,  
        ...
        log.info( " ElasticRecordIndex(add): transformation start (" 
                  + fileName + ")..." + rt );
        ...
        while( rt.hasNext() ){
            ...
            log.debug( " ElasticRecordIndex(add): recId=" + recId );
            log.debug( " ElasticRecordIndex(add):" 
                       + " SIDoc=" + doc.toString() );
    ...
    */
    ...
    public Map getMeta(){
        ...
        metaMap.put("resource-type","elastic");

        /*
        Log log = LogFactory.getLog( this.getClass() );
        log.debug( "getMeta: DefElasticParams=" + defSolrParams );
